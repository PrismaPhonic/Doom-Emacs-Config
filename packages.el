...
;; (package! forge
;;            :recipe (:repo "magit/forge" :repo "https://github.com/magit/forge.git")
;;            :pin "47dbaf7bbe14845724113c166a18d4224708de5"

(package! slack
  :recipe (:host github :repo "emacs-slack/emacs-slack"))

(package! emacstv
  :recipe (:host github :repo "emacstv/emacstv.github.io"
           :files (:defaults "*.org")))
